...
class Liste : Fragment() {
    ...
    private lateinit var listeAdapter:ListeRecyclerAdapter   //burada tanımlamamızın sebebi.. Yeni veriler eklendiğinde direkt adapterle recycleye bağlansın
        ...
        fun sqlVeriAlma(){
            try{
                activity?.let {
                    ...
                    val cursor=database.rawQuery("SELECT * FROM yemekler",null)   //ikinci parametre kısmına kısıtlamalar yazılır
